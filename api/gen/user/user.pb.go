...
const file_user_proto_rawDesc = "" +
	...
	"\x11GetPublicUserInfo\x12\x1e.user.GetPublicUserInfoRequest\x1a\x1f.user.GetPublicUserInfoResponse\x129\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*KickUserRequest)(nil),           // 6: user.KickUserRequest
	(*KickUserResponse)(nil),          // 7: user.KickUserResponse
}
var file_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.UpdateUserInfo:input_type -> user.UpdateUserInfoRequest
	2, // 1: user.UserService.GetUserInfo:input_type -> user.GetUserInfoRequest
	4, // 2: user.UserService.GetPublicUserInfo:input_type -> user.GetPublicUserInfoRequest
	6, // 3: user.UserService.KickUser:input_type -> user.KickUserRequest
	1, // 4: user.UserService.UpdateUserInfo:output_type -> user.UpdateUserInfoResponse
	3, // 5: user.UserService.GetUserInfo:output_type -> user.GetUserInfoResponse
	5, // 6: user.UserService.GetPublicUserInfo:output_type -> user.GetPublicUserInfoResponse
	7, // 7: user.UserService.KickUser:output_type -> user.KickUserResponse
